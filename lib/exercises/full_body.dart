...
class FullBodyPage extends StatelessWidget {
  ...
  final List<Exercise> exercises = const [
    Exercise(
      name: 'Star-Jumps',
      imageUrl: 'assets/gifs/starjump.gif',
      sets: 3,
      reps: 12,
    ),
    Exercise(
      name: 'Gyno reps',
      imageUrl: 'assets/gifs/parts/fullbody/gynoreps.gif',
      sets: 3,
      reps: 15,
    ),
    Exercise(
      name: 'Dumbell-Squat-Raise',
      imageUrl: 'assets/gifs/parts/fullbody/fbdumbellsquatraise.gif',
      sets: 3,
      reps: 15,
    ),
    Exercise(
      name: 'High-Knees',
      imageUrl: 'assets/gifs/parts/fullbody/fbhighknees.gif',
      sets: 3,
      reps: 12,
    ),
  ];
